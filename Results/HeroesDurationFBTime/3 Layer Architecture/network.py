...
directory = 'E:/Documents\GitHub/Dota2Predictor/TensorBoard/HeroesDurationFBTime/3 Layer Architecture'
...
model.save('HeroesDurationFBTime.h5')
...
plot_confusion_matrix(cnf_matrix, classes=[0,1],
                      title='Confusion Matrix - HeroesDurationFBTime')

# Plot normalized confusion matrix
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=[0,1], normalize=True,
                     title='Normalized Confusion Matrix - HeroesDurationFBTime')
